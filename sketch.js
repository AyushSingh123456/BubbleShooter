...
function setup() {
  ...
  player = createSprite(200,350,100,100);
...
//bubbles
  ...
  bubble11 = createSprite(random(10,390),random(10,390),random(20,40),random(20,40));
  bubble12 = createSprite(random(10,390),random(10,390),random(20,40),random(20,40));
  bubble13 = createSprite(random(10,390),random(10,390),random(20,40),random(20,40));
  bubble14 = createSprite(random(10,390),random(10,390),random(20,40),random(20,40));
  bubble15 = createSprite(random(10,390),random(10,390),random(20,40),random(20,40));
  bubble16 = createSprite(random(10,390),random(10,390),random(20,40),random(20,40));
  bubble17 = createSprite(random(10,390),random(10,390),random(20,40),random(20,40));
  bubble18 = createSprite(random(10,390),random(10,390),random(20,40),random(20,40));

  bubbles = [bubble1,bubble2,bubble3,bubble4,bubble5,bubble6,bubble7,bubble8,bubble9,bubble10, bubble11,bubble12,bubble13,bubble14,bubble15,bubble16,bubble17,bubble18];
...
//movement of bubbles
  for(var i = 0;i<bubbles.length;i++){
    bubbles[i].setVelocity(random(-10,10),random(-10,10));
  }
//sparkles when win
  /*for(var h = 0;h<200;h++){
